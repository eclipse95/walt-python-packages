...
def update_named_conf(dns_info):
    ...
    for rev_zone_name in np.unique(dns_info.rev_zone_name):
        ...
        changed |= possibly_update_file(
            rev_zone_file, rev_zone_content, diff_preprocessing=serial_removed
        )
